...
SystemInfo["HasHDMI-CEC"] = HardwareInfo().get_device_model() not in ("cuberevo", "cuberevo_mini-fta", "cuberevo-250hd", "cuberevo-mini", "cuberevo-mini2", "cuberevo-2000hd", "cuberevo-3000hd", "cuberevo-9500hd", "hl101") and fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/HdmiCEC/plugin.pyo") and (fileExists("/dev/cec0") or fileExists("/dev/hdmi_cec") or fileExists("/dev/misc/hdmi_cec0"))
SystemInfo["HasYPbPr"] = HardwareInfo().get_device_model() in ("adb_box", "atevio7500", "fortis_hdbox", "hl101", "hs7420", "hs7429", "octagon1008", "tf7700","ufs912", "ufs913", "vip1_v2", "vip2_v1", "cuberevo", "cuberevo_mini", "cuberevo_mini2", "cuberevo_2000hd", "cuberevo_3000hd")
SystemInfo["HasScart"] = HardwareInfo().get_device_model() not in ("hs7110", "hs7119")
SystemInfo["HasSVideo"] = HardwareInfo().get_device_model() in ("cuberevo")
SystemInfo["HasComposite"] = HardwareInfo().get_device_model() not in ("cuberevo-250hd")
