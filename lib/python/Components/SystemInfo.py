...
SystemInfo["HasYPbPr"] = model in ("adb_box", "atevio7500", "fortis_hdbox", "hl101", "hs7420", "hs7429", "octagon1008", "tf7700","ufs912", "ufs913", "vip1_v2", "vip2_v1", "cuberevo", "cuberevo_mini", "cuberevo_mini2", "cuberevo_2000hd", "cuberevo_3000hd")
SystemInfo["HasScart"] = model not in ("hs7110", "hs7119")
SystemInfo["HasSVideo"] = model not in ("cuberevo")
SystemInfo["HasComposite"] = model not in ("cuberevo-250hd")
